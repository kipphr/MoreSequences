...
def run_test_make_simple_list():
    ...
    expected = [10000, 10001, 10002, 10003, 10004]
    actual = make_simple_list(10000, 10004)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_simple_string():
    ...
    # Test 1:
    expected = str("20000-20001-20002-20003-20004-")
    actual = make_simple_string(20000, 20004)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def make_simple_string(m, n):
    ...
    simple_string = str("")
    for k in range(m, n + 1):
        simple_string = simple_string + str(k) + str("-")
...
def run_test_make_less_simple_string():
    ...
    # Test 1:
    expected = str("20000-20001-20002-20003-20004")
    actual = make_less_simple_string(20000, 20004)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def make_less_simple_string(m, n):
    ...
    less_simple_string = str("")
    for k in range(m, n + 1):
        less_simple_string = less_simple_string + str(k)
        if k < n:
            less_simple_string = less_simple_string + str("-")
